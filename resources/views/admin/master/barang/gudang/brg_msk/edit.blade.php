                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button class="btn btn-primary btn-round ml-auto" href="/brg_msk/create"
                            ...
                            <div class="card-body">
                                <form action="{{$brg_msk->id}}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-group">
                                        <label>no barang</label>
                                        <input type="text" class="form-control" name="no_brg_masuk"
                                            value="{{ $brg_msk->no_brg_masuk }}">
                                    </div>


                                    <div class="form-group">
                                        <label>id barang</label>
                                        <input type="text" class="form-control" readonly="" name="nama_barang"
                                            value="{{ $brg_msk->id_barang }}" id="nama_barang">
                                    </div>

                                    <input type="hidden" value="{{ Auth::user()->id }}" name="id_user">
                                    <input type="hidden" value="{{ $brg_msk->id_barang }}" name="id_barang">
                        ...
                        @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="jml_brg_masuk"
                                                value="{{ $brg_msk->jml_brg_masuk }}" id="jumlah">
                                        </div>
                                    </div>
                       ...
                       <input type="text" class="form-control" name="total" id="total">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="text" id="total" class="form-control" name="total"
                                            placeholder="Total" value="{{ $brg_msk->total }}">
                                    </div>
