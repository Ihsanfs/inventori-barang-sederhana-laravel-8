                                ...
                                <form action="{{$barang->id}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_barang"
                                            value="{{ $brg->nama_barang }}" id="nama_barang">
                                    </div>
                        ...
                        @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number " class="form-control" name="harga"
                                                value="{{ $brg->harga }}" id="harga"  disabled>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number " class="form-control" name="jml_brg_keluar"
                                                value="{{ $barang->jml_brg_keluar }}" id="jumlah">
                                        </div>
                                    </div>
                       ...
                       <input type="text" class="form-control" name="total" id="total">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="text" id="total" class="form-control" name="total"
                                            placeholder="Total" value="{{ $barang->total }}">
                                    </div>
